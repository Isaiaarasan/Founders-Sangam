...
const EventsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 pt-2 pb-5 px-6 md:px-5 transition-colors duration-500">
          ...
          <>
            ...
            >
              ...
              <p className="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
                Join us for networking sessions, workshops, and exclusive
                meetups designed for founders.
              </p>
            </motion.div>
