                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-5 py-4 rounded-xl bg-gray-50 dark:bg-[#111] border border-gray-200 dark:border-neutral-800 text-neutral-900 dark:text-white placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition-all duration-300 font-medium"
                        ...
                        <button
                            type="submit"
                            className="group w-full py-4 mt-6 bg-neutral-900 dark:bg-white text-white dark:text-black rounded-xl font-bold text-lg hover:shadow-xl hover:shadow-amber-900/10 dark:hover:shadow-white/10 hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2"
                        >
                            Secure Login
